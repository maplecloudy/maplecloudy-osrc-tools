...
public class JarModeLibrary extends Library {
	 ...
	 */
	public static final JarModeLibrary LAYER_TOOLS = new JarModeLibrary("maplecloudy-osrt-jarmode-layertools");
	...
	private static LibraryCoordinates createCoordinates(String artifactId) {
		...
		return LibraryCoordinates.of("com.maplecloudy.osrt", artifactId, version);
	}
