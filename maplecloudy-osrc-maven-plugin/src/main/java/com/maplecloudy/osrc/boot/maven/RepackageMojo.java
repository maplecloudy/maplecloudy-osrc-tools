...
import com.maplecloudy.osrc.boot.loader.tools.DefaultLaunchScript;
import com.maplecloudy.osrc.boot.loader.tools.LaunchScript;
import com.maplecloudy.osrc.boot.loader.tools.LayoutFactory;
import com.maplecloudy.osrc.boot.loader.tools.Libraries;
import com.maplecloudy.osrc.boot.loader.tools.Repackager;
...
public class RepackageMojo extends AbstractPackagerMojo {
	 ...
	 * @since 1.0.0
	 */
	@Parameter(defaultValue = "${project.build.finalName}-osrc-app", readonly =
			true)
	 ...
	 * @since 1.2.0
	 */
	@Parameter(property = "osrc.repackage.skip", defaultValue = "false")
	 ...
	 * @since 1.0.0
	 */
	@Parameter(property = "osrc.repackage.layout")
	...
	private void repackage() throws MojoExecutionException {
		...
		Repackager repackager = getRepackager(this.project,source);
	...
	private Repackager getRepackager(MavenProject project,Artifact source) {
		return getConfiguredPackager(() -> new Repackager(project,source));
	}
