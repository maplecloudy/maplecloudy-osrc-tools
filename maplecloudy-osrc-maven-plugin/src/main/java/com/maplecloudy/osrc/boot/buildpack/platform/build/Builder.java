...
import com.maplecloudy.osrc.boot.buildpack.platform.docker.transport.DockerEngineException;
import com.maplecloudy.osrc.boot.buildpack.platform.docker.type.Image;
import com.maplecloudy.osrc.boot.buildpack.platform.docker.type.ImageReference;
import com.maplecloudy.osrc.boot.buildpack.platform.io.IOBiConsumer;
import com.maplecloudy.osrc.boot.buildpack.platform.io.TarArchive;
import org.springframework.util.Assert;
import org.springframework.util.StringUtils;

import com.maplecloudy.osrc.boot.buildpack.platform.build.BuilderMetadata.Stack;
import com.maplecloudy.osrc.boot.buildpack.platform.docker.DockerApi;
import com.maplecloudy.osrc.boot.buildpack.platform.docker.TotalProgressEvent;
import com.maplecloudy.osrc.boot.buildpack.platform.docker.TotalProgressPullListener;
import com.maplecloudy.osrc.boot.buildpack.platform.docker.TotalProgressPushListener;
import com.maplecloudy.osrc.boot.buildpack.platform.docker.UpdateListener;
