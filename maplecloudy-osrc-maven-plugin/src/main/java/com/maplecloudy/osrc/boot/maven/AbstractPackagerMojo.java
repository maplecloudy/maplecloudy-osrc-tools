...
import com.maplecloudy.osrc.boot.loader.tools.Layout;
import com.maplecloudy.osrc.boot.loader.tools.LayoutFactory;
import com.maplecloudy.osrc.boot.loader.tools.Libraries;
import com.maplecloudy.osrc.boot.loader.tools.Packager;
import com.maplecloudy.osrc.boot.loader.tools.Layouts.Expanded;
import com.maplecloudy.osrc.boot.loader.tools.Layouts.Jar;
import com.maplecloudy.osrc.boot.loader.tools.Layouts.None;
import com.maplecloudy.osrc.boot.loader.tools.Layouts.War;
import com.maplecloudy.osrc.boot.loader.tools.MainClassFinder.MainClass;
import com.maplecloudy.osrc.boot.loader.tools.layer.CustomLayers;
...
public abstract class AbstractPackagerMojo extends AbstractDependencyFilterMojo {
	...
	private static final com.maplecloudy.osrc.boot.loader.tools.Layers IMPLICIT_LAYERS = com.maplecloudy.osrc.boot.loader.tools.Layers.IMPLICIT;
	...
	protected <P extends Packager> P getConfiguredPackager(Supplier<P> supplier) {
		...
		Set<MainClass> mainClassSet = Sets.newHashSet();
		if(this.mainClass == null)
		  this.mainClass = Sets.newHashSet();
		this.mainClass.forEach(main -> {
		  mainClassSet.add(new MainClass(main));
		});
		packager.setMainClass(mainClassSet);
