...
import com.maplecloudy.osrt.boot.loader.tools.DefaultLaunchScript;
import com.maplecloudy.osrt.boot.loader.tools.LaunchScript;
import com.maplecloudy.osrt.boot.loader.tools.LayoutFactory;
import com.maplecloudy.osrt.boot.loader.tools.Libraries;
import com.maplecloudy.osrt.boot.loader.tools.Repackager;
...
public class RepackageMojo extends AbstractPackagerMojo {
	 ...
	 * @since 1.2.0
	 */
	@Parameter(property = "osrt.repackage.skip", defaultValue = "false")
	 ...
	 * @since 1.0.0
	 */
	@Parameter(property = "osrt.repackage.layout")
