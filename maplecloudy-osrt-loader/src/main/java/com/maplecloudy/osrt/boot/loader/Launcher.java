...
package com.maplecloudy.osrt.boot.loader;
...
import com.maplecloudy.osrt.boot.loader.archive.Archive;
import com.maplecloudy.osrt.boot.loader.archive.ExplodedArchive;
import com.maplecloudy.osrt.boot.loader.archive.JarFileArchive;
import com.maplecloudy.osrt.boot.loader.jar.JarFile;
...
public abstract class Launcher {
	...
	private static final String JAR_MODE_LAUNCHER = "com.maplecloudy.osrt.boot.loader.jarmode.JarModeLauncher";
	...
	protected void launch(String[] args) throws Exception {
        ...
        JAR_MODE_LAUNCHER : getMainClass(args);
   ...
   * @param args
	 */
	protected abstract String getMainClass(String[] args) throws Exception;
