...
import com.maplecloudy.osrt.boot.loader.jar.Handler;
...
public class LaunchedURLClassLoader extends URLClassLoader {
	...
	protected Class<?> loadClass(String name, boolean resolve) throws ClassNotFoundException {
		if (name.startsWith("com.maplecloudy.osrt.boot.loader.jarmode.")) {
			try {
	...
	private void clearCache(URLConnection connection) throws IOException {
		...
		if (jarFile instanceof com.maplecloudy.osrt.boot.loader.jar.JarFile) {
			((com.maplecloudy.osrt.boot.loader.jar.JarFile) jarFile).clearCache();
		}
	}
