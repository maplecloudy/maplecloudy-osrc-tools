...
import com.maplecloudy.osrc.boot.loader.jar.Handler;
...
public class LaunchedURLClassLoader extends URLClassLoader {
	...
	protected Class<?> loadClass(String name, boolean resolve) throws ClassNotFoundException {
		if (name.startsWith("com.maplecloudy.osrc.boot.loader.jarmode.")) {
			try {
	...
	private void clearCache(URLConnection connection) throws IOException {
		...
		if (jarFile instanceof com.maplecloudy.osrc.boot.loader.jar.JarFile) {
			((com.maplecloudy.osrc.boot.loader.jar.JarFile) jarFile).clearCache();
		}
	}
