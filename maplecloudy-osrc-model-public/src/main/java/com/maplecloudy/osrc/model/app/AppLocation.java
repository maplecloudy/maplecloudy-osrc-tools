...
public abstract class AppLocation {
  ...
  private String osrcAppKey;

  private String osrcAppPath;
  ...
  @Schema(description = "")
  public String getOsrcAppKey() {
    return this.osrcAppKey;
  }

  @Schema(description = "")
  public String getOsrcAppPath() {
    return this.osrcAppPath;
  }

  public void setOsrcAppKey(String osrcAppKey) {
    this.osrcAppKey = osrcAppKey;
  }

  public void setOsrcAppPath(String osrcAppPath) {
    this.osrcAppPath = osrcAppPath;
  }
